...
@Suite("kDrive delete favorite-file request")
struct KDriveDeleteFavoriteFileRequestTests {
    @Test("kDrive delete favorite-file request matches the OpenAPI method, path, headers, query, and body")
    func requestMatchesOpenAPIShape() async throws {
        ...
        let request = KDriveRequests.unfavoriteFile(driveId: 100, fileId: 42)
    ...
    @Test("kDrive delete favorite-file response decodes boolean success data")
