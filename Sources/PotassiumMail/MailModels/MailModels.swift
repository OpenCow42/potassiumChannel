...
public struct MailMailbox: Codable, Equatable, Sendable {
    ...
    public let values: [String: MailJSONValue]

    /// Creates a mailbox wrapper around a raw JSON payload.
    public init(values: [String: MailJSONValue]) {
        self.values = values
    }

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        self.values = try container.decode([String: MailJSONValue].self)
    }
...
public struct MailboxAliases: Codable, Equatable, Sendable {
    ...
    /// Creates an aliases wrapper around a raw JSON payload.
    public init(values: [String: MailJSONValue]) {
        self.values = values
    }
...
public struct MailDraftPayload: Codable, Equatable, Sendable {
    ...
    public let attachments: [MailJSONValue]
