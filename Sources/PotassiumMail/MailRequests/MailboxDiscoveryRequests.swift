...
extension MailRequests {
    ...
    public static func deleteDraft(mailboxUUID: String, draftUUID: String) -> APIRequest<InfomaniakResponse<MailJSONValue>> {
        APIRequest(
            method: .delete,
            path: "/api/mail/\(mailboxUUID)/draft/\(draftUUID)"
        )
    ...
    public static func deleteSchedule(scheduleAction: String) -> APIRequest<InfomaniakResponse<MailJSONValue>> {
        APIRequest(
            method: .delete,
            path: scheduleAction
        )
    ...
    public static func cancelSend(cancelSendResource: String) -> APIRequest<InfomaniakResponse<MailJSONValue>> {
        APIRequest(
            method: .put,
